/**
  * @license ng2-smart-table-extended v1.0.0
...
var Cell = /** @class */ (function () {
    ...
    Cell.prototype.getDataSet = function () {
        return this.dataSet;
    };
...
var CellComponent = /** @class */ (function () {
    ...
    CellComponent.decorators = [
        { type: core.Component, args: [{
                    selector: 'ng2-smart-table-extended-cell',
...
var PagerComponent = /** @class */ (function () {
    ...
    PagerComponent.decorators = [
        { type: core.Component, args: [{
                    selector: 'ng2-smart-table-extended-pager',
...
var ColumnTitleComponent = /** @class */ (function () {
    ...
    ColumnTitleComponent.decorators = [
        { type: core.Component, args: [{
                    ...
                    template: "\n    <div class=\"ng2-smart-title\">\n      <ng2-smart-table-extended-title [source]=\"source\" [column]=\"column\" (sort)=\"sort.emit($event)\"></ng2-smart-table-extended-title>\n    </div>\n  ",
                },] },
    ];
    /** @nocollapse */
...
var TitleComponent = /** @class */ (function () {
    ...
    TitleComponent.decorators = [
        { type: core.Component, args: [{
                    selector: 'ng2-smart-table-extended-title',
...
var TheadFitlersRowComponent = /** @class */ (function () {
    ...
    TheadFitlersRowComponent.decorators = [
        { type: core.Component, args: [{
                    ...
                    template: "\n    <th *ngIf=\"isMultiSelectVisible\"></th>\n    <th ng2-st-add-button *ngIf=\"showActionColumnLeft\"\n                          [grid]=\"grid\"\n                          (create)=\"create.emit($event)\">\n    </th>\n    <th *ngFor=\"let column of grid.getColumns()\" class=\"ng2-smart-th {{ column.id }}\">\n      <ng2-smart-table-extended-filter [source]=\"source\"\n                              [column]=\"column\"\n                              [inputClass]=\"filterInputClass\"\n                              (filter)=\"filter.emit($event)\">\n      </ng2-smart-table-extended-filter>\n    </th>\n    <th ng2-st-add-button *ngIf=\"showActionColumnRight\"\n                          [grid]=\"grid\"\n                          [source]=\"source\"\n                          (create)=\"create.emit($event)\">\n    </th>\n  ",
                },] },
    ];
    /** @nocollapse */
...
var TheadFormRowComponent = /** @class */ (function () {
    ...
    TheadFormRowComponent.decorators = [
        { type: core.Component, args: [{
                    ...
                    template: "\n      <td *ngIf=\"\"></td>\n      <td  *ngIf=\"showActionColumnLeft\"  class=\"ng2-smart-actions\">\n        <ng2-st-actions [grid]=\"grid\" (create)=\"onCreate($event)\"></ng2-st-actions>\n      </td>\n      <td *ngFor=\"let cell of grid.getNewRow().getCells()\">\n        <ng2-smart-table-extended-cell [cell]=\"cell\"\n                              [grid]=\"grid\"\n                              [isNew]=\"true\"\n                              [createConfirm]=\"createConfirm\"\n                              [inputClass]=\"addInputClass\"\n                              [isInEditing]=\"grid.getNewRow().isInEditing\"\n                              (edited)=\"onCreate($event)\">\n        </ng2-smart-table-extended-cell>\n      </td>\n      <td  *ngIf=\"showActionColumnRight\"  class=\"ng2-smart-actions\">\n        <ng2-st-actions [grid]=\"grid\" (create)=\"onCreate($event)\"></ng2-st-actions>\n      </td>\n  ",
                },] },
    ];
    /** @nocollapse */
...
var Ng2SmartTableExtendedComponent = /** @class */ (function () {
    function Ng2SmartTableExtendedComponent() {
        this.settings = {};
        ...
        this.defaultSettings = {
            ...
            edit: {
                ...
                confirmSave: false,
                editClassFunction: function () { return ""; },
            },
            add: {
                inputClass: '',
            ...
            delete: {
                ...
                confirmDelete: false,
                deleteClassFunction: function () { return ""; },
            },
            attr: {
                id: '',
                class: '',
    ...
    Ng2SmartTableExtendedComponent.prototype.ngOnChanges = function (changes) {
        if (this.grid) {
            if (changes['settings']) {
    ...
    Ng2SmartTableExtendedComponent.prototype.editRowSelect = function (row) {
    ...
    Ng2SmartTableExtendedComponent.prototype.onUserSelectRow = function (row) {
        if (this.grid.getSetting('selectMode') !== 'multi') {
    ...
    Ng2SmartTableExtendedComponent.prototype.onRowHover = function (row) {
        this.rowHover.emit(row);
    };
    Ng2SmartTableExtendedComponent.prototype.multipleSelectRow = function (row) {
        this.grid.multipleSelectRow(row);
        this.emitUserSelectRow(row);
        this.emitSelectRow(row);
    };
    Ng2SmartTableExtendedComponent.prototype.onSelectAllRows = function ($event) {
        this.isAllSelected = !this.isAllSelected;
        this.grid.selectAllRows(this.isAllSelected);
        this.emitUserSelectRow(null);
        this.emitSelectRow(null);
    };
    Ng2SmartTableExtendedComponent.prototype.onSelectRow = function (row) {
        this.grid.selectRow(row);
        this.emitSelectRow(row);
    };
    Ng2SmartTableExtendedComponent.prototype.onMultipleSelectRow = function (row) {
        this.emitSelectRow(row);
    };
    Ng2SmartTableExtendedComponent.prototype.initGrid = function () {
        var _this = this;
        this.source = this.prepareSource();
        this.grid = new Grid(this.source, this.prepareSettings());
        this.grid.onSelectRow().subscribe(function (row) { return _this.emitSelectRow(row); });
    };
    Ng2SmartTableExtendedComponent.prototype.prepareSource = function () {
    ...
    Ng2SmartTableExtendedComponent.prototype.prepareSettings = function () {
        return deepExtend({}, this.defaultSettings, this.settings);
    };
    Ng2SmartTableExtendedComponent.prototype.changePage = function ($event) {
        this.resetAllSelector();
    };
    Ng2SmartTableExtendedComponent.prototype.sort = function ($event) {
        this.resetAllSelector();
    };
    Ng2SmartTableExtendedComponent.prototype.filter = function ($event) {
        this.resetAllSelector();
    };
    Ng2SmartTableExtendedComponent.prototype.resetAllSelector = function () {
        this.isAllSelected = false;
    };
    Ng2SmartTableExtendedComponent.prototype.emitUserSelectRow = function (row) {
    ...
    Ng2SmartTableExtendedComponent.prototype.emitSelectRow = function (row) {
        this.rowSelect.emit({
            data: row ? row.getData() : null,
            isSelected: row ? row.getIsSelected() : null,
            source: this.source,
    ...
    return Ng2SmartTableExtendedComponent;
}());
...
exports.Ng2SmartTableExtendedModule = Ng2SmartTableExtendedModule;
